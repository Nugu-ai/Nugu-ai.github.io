...
1) Vertex positions
    A squarePyramin has 5 faces and each face except for the bottom one has 3 vertices the bottom one has 4 verties
...
export class squarePyramid {
    constructor(gl, options = {}) {
        ...
        // 정점 좌표 (총 16개: bottom 4, side 4 faces * 3)
        this.vertices = new Float32Array([
            // bottom face
            -0.5, 0.0, -0.5, 0.5, 0.0, -0.5, 0.5, 0.0, 0.5, -0.5, 0.0, 0.5,

            // front face (apex, left, right)
