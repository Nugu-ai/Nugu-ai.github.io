...
let shadingModeText = shadingMode + " (" + renderingMode + ")";
...
async function main() {
    try {
        ...
        textOverlay2 = setupText(canvas, "shading mode: " + shadingModeText, 2);
        ...
        textOverlay5 = setupText(
            canvas,
            "press 's' to switch to smooth shading",
            5
        );
        textOverlay6 = setupText(
            canvas,
            "press 'f' to switch to flat shading",
            6
        );
        textOverlay7 = setupText(
            canvas,
            "press 'g' to switch to Gouraud shading",
            7
        );
        textOverlay8 = setupText(
            canvas,
